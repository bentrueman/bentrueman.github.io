...
```
The following codes tests that it gives the expected result when applied to the data in Table 9.7 of @helsel_statistics_2012. First, here are the data:
...
And here are the test results. These match the results in @helsel_statistics_2012.
