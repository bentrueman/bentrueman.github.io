...
```{r load-fit, echo=FALSE, eval=FALSE}

# note that reading a stan model from CSVs and feeding it back into brms causes warmup draws to be included where they shouldn't. This issue should be fixed in the next release (https://github.com/paul-buerkner/brms/issues/1284)
