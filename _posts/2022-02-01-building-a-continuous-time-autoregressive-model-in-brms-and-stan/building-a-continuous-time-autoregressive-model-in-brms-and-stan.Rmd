...
UPDATES:   
1. This material is now implemented in an R package, [`bgamcar1`](https://github.com/bentrueman/bgamcar1), focused on GAMs with CAR(1) errors as a quick fix until this a CAR(1) option is added to [`brms`](https://github.com/paul-buerkner/brms/issues/741).  
