...
We fit the same model as we did on the training data. The augmented model excludes all of the response values from the test set; these are imputed during model fitting (and then discarded).
