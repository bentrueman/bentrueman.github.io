...
In this post I demonstrate the package on a single time series, one of many we used in the paper. Here are the data:
...
The variance of the residuals was also reasonably constant, apart from a few outliers and perhaps a slight reduction towards the end of the series.
...
But overall, there's not much evidence here that the GAM describes this particular series any better than the linear model. 
...
model_brms <- brm(
  bf((log(value)) | cens(censored) ~ 
       s(numeric_date) + ar(time = numeric_date, p = 1)),
  data = model_in_brms,
  iter = 4000,
