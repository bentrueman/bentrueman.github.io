...
data <- read_tsv("XRD_Ortho_P_pH7.5_DIC50 copy.txt", col_names = FALSE) %>% 
  ...
  correct_baseline(left = 19, right = 80, group_vars = NULL, x_var = "two_theta", y_var = "intensity")
